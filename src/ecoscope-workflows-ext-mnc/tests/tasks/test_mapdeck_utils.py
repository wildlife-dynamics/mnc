...
class TestCreateGdfFromDict:
    ...
    def sample_gdf_dict(self):
        ...
        return {"trajectories": gdf1, "areas_of_interest": gdf2, "protected_areas": gdf3}
...
class TestExcludeGeomOutliers:
    ...
    def sample_gdf_with_outliers(self):
        ...
        gdf = gpd.GeoDataFrame({"id": range(len(points))}, geometry=points, crs="EPSG:4326")
        return gdf
    ...
    def test_only_works_with_point_geometries(self):
        ...
        gdf = gpd.GeoDataFrame({"id": range(len(lines))}, geometry=lines, crs="EPSG:4326")
