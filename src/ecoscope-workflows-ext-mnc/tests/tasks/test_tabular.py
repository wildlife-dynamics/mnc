...
class TestMapNameValues:
    ...
    def test_map_name_basic(self):
        ...
        df = pd.DataFrame({
            'name': ['john_doe', 'jane_smith', 'bob_jones']
        })
